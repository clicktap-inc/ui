...
const TemplateColsTemplate: ComponentStory<typeof Grid> = (args) =>
  <Grid {...args} cols={4} gap={'1rem'} css={css`
...
const TemplateColSpanTemplate: ComponentStory<typeof Grid> = (args) =>
  <Grid {...args} cols={3} gap={'1rem'} css={css`
    background-size: 7.07px 7.07px;
    color: #FFF;
    font-weight: bold;
    text-align: center;
  ...
  `}>
    ...
    <GridItem colSpan={2} css={GridItemColSpanDarkCss}>04</GridItem>
    <GridItem css={GridItemColSpanCss}>05</GridItem>
    <GridItem css={GridItemColSpanCss}>06</GridItem>
    <GridItem colSpan={2} css={GridItemColSpanDarkCss}>07</GridItem>
  </Grid>;
...
const TemplateColStartEndTemplate: ComponentStory<typeof Grid> = (args) =>
  <Grid {...args} cols={6} gap={'1rem'} css={css`
    background-size: 7.07px 7.07px;
    color: #FFF;
    font-weight: bold;
    text-align: center;
    ...
    line-height: 1.5;
  `}>
    <GridItem css={GridItemColStartEndSpacerCss}></GridItem>
    <GridItem colStart={2} colSpan={4} css={GridItemColStartEndCss}>01</GridItem>
    <GridItem css={GridItemColStartEndSpacerCss}></GridItem>
    <GridItem colStart={1} colEnd={3} css={GridItemColStartEndCss}>02</GridItem>
    <GridItem css={GridItemColStartEndSpacerCss}></GridItem>
    <GridItem css={GridItemColStartEndSpacerCss}></GridItem>
    <GridItem colEnd={7} colSpan={2} css={GridItemColStartEndCss}>03</GridItem>
    <GridItem colStart={1} colEnd={7} css={GridItemColStartEndCss}>04</GridItem>
  </Grid>;
...
const TemplateRowsTemplate: ComponentStory<typeof Grid> = (args) =>
  <Grid {...args} rows={4} gap={'1rem'} autoFlow="column" css={css`
...
const TemplateRowSpanTemplate: ComponentStory<typeof Grid> = (args) =>
  <Grid {...args} rows={3} autoFlow="column" gap={'1rem'} css={css`
    background-color: #e879f91a;
    background-image: linear-gradient(135deg,#d946ef80 10%,transparent 0,transparent 50%,#d946ef80 0,#d946ef80 60%,transparent 0,transparent);
    background-size: 7.07px 7.07px;
    color: #FFF;
    ...
    line-height: 1.5;
  `}>
    <GridItem rowSpan={3} css={GridItemRowSpanDarkCss}>01</GridItem>
    <GridItem colSpan={2} css={GridItemRowSpanCss}>02</GridItem>
    <GridItem rowSpan={2} colSpan={2} css={GridItemRowSpanDarkCss}>03</GridItem>
  </Grid>;
...
const TemplateRowStartEndTemplate: ComponentStory<typeof Grid> = (args) =>
  <Grid {...args} rows={3} autoFlow="column" gap={'1rem'} css={css`
    ...
    line-height: 1.5;
  `}>
    <GridItem rowStart={2} rowSpan={2} css={GridItemRowStartEndCss}>01</GridItem>
    <GridItem rowEnd={3} rowSpan={2} css={GridItemRowStartEndCss}>02</GridItem>
    <GridItem rowStart={1} rowEnd={4} css={GridItemRowStartEndCss}>03</GridItem>
  </Grid>;
...
const TemplateAutoflowTemplate: ComponentStory<typeof Grid> = (args) =>
  <Grid {...args} cols={3} rows={3} autoFlow="row dense" gap={'1rem'} css={css`
    ...
    line-height: 1.5;
  `}>
    <GridItem colSpan={2} css={GridItemAutoflowCss}>01</GridItem>
    <GridItem colSpan={2} css={GridItemAutoflowCss}>02</GridItem>
...
const GridItemJustifyItemsStartInner = styled.div`
  ...
  border-radius: 0.5rem;
`;
const TemplateJustifyItemsStartTemplate: ComponentStory<typeof Grid> = (args) =>
  <Grid {...args} cols={3} gap={'1rem'} css={css`
    color: #FFF;
    font-weight: bold;
    text-align: center;
    ...
    line-height: 1.5;
  `}>
    <Grid justifyItems='start' css={GridItemJustifyItemsStartCss}><GridItemJustifyItemsStartInner>01</GridItemJustifyItemsStartInner></Grid>
    <Grid justifyItems='start' css={GridItemJustifyItemsStartCss}><GridItemJustifyItemsStartInner>02</GridItemJustifyItemsStartInner></Grid>
    <Grid justifyItems='start' css={GridItemJustifyItemsStartCss}><GridItemJustifyItemsStartInner>03</GridItemJustifyItemsStartInner></Grid>
    <Grid justifyItems='start' css={GridItemJustifyItemsStartCss}><GridItemJustifyItemsStartInner>04</GridItemJustifyItemsStartInner></Grid>
    <Grid justifyItems='start' css={GridItemJustifyItemsStartCss}><GridItemJustifyItemsStartInner>05</GridItemJustifyItemsStartInner></Grid>
    <Grid justifyItems='start' css={GridItemJustifyItemsStartCss}><GridItemJustifyItemsStartInner>06</GridItemJustifyItemsStartInner></Grid>
  </Grid>;
...
const TemplateJustifyItemsEndTemplate: ComponentStory<typeof Grid> = (args) =>
  <Grid {...args} cols={3} gap={'1rem'} css={css`
    ...
    line-height: 1.5;
  `}>
    <Grid justifyItems='end' css={GridItemJustifyItemsEndCss}><GridItemJustifyItemsEndInner>01</GridItemJustifyItemsEndInner></Grid>
    <Grid justifyItems='end' css={GridItemJustifyItemsEndCss}><GridItemJustifyItemsEndInner>02</GridItemJustifyItemsEndInner></Grid>
    <Grid justifyItems='end' css={GridItemJustifyItemsEndCss}><GridItemJustifyItemsEndInner>03</GridItemJustifyItemsEndInner></Grid>
    <Grid justifyItems='end' css={GridItemJustifyItemsEndCss}><GridItemJustifyItemsEndInner>04</GridItemJustifyItemsEndInner></Grid>
    <Grid justifyItems='end' css={GridItemJustifyItemsEndCss}><GridItemJustifyItemsEndInner>05</GridItemJustifyItemsEndInner></Grid>
    <Grid justifyItems='end' css={GridItemJustifyItemsEndCss}><GridItemJustifyItemsEndInner>06</GridItemJustifyItemsEndInner></Grid>
  </Grid>;
...
const GridItemJustifyItemsCenterInner = styled.div`
  ...
  border-radius: 0.5rem;
`;
const TemplateJustifyItemsCenterTemplate: ComponentStory<typeof Grid> = (args) =>
  <Grid {...args} cols={3} gap={'1rem'} css={css`
    color: #FFF;
    font-weight: bold;
    text-align: center;
    ...
    line-height: 1.5;
  `}>
    <Grid justifyItems='center' css={GridItemJustifyItemsCenterCss}><GridItemJustifyItemsCenterInner>01</GridItemJustifyItemsCenterInner></Grid>
    <Grid justifyItems='center' css={GridItemJustifyItemsCenterCss}><GridItemJustifyItemsCenterInner>02</GridItemJustifyItemsCenterInner></Grid>
    <Grid justifyItems='center' css={GridItemJustifyItemsCenterCss}><GridItemJustifyItemsCenterInner>03</GridItemJustifyItemsCenterInner></Grid>
    <Grid justifyItems='center' css={GridItemJustifyItemsCenterCss}><GridItemJustifyItemsCenterInner>04</GridItemJustifyItemsCenterInner></Grid>
    <Grid justifyItems='center' css={GridItemJustifyItemsCenterCss}><GridItemJustifyItemsCenterInner>05</GridItemJustifyItemsCenterInner></Grid>
    <Grid justifyItems='center' css={GridItemJustifyItemsCenterCss}><GridItemJustifyItemsCenterInner>06</GridItemJustifyItemsCenterInner></Grid>
  </Grid>;

export const TemplateJustifyItemsCenter = TemplateJustifyItemsCenterTemplate.bind({});
...
const GridItemJustifyItemsStretchInner = styled.div`
  ...
  border-radius: 0.5rem;
`;
const TemplateJustifyItemsStretchTemplate: ComponentStory<typeof Grid> = (args) =>
  <Grid {...args} cols={3} gap={'1rem'} justifyItems='stretch' css={css`
    color: #FFF;
    font-weight: bold;
    text-align: center;
    font-family: "Fira Code VF", ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace;
...
export const TemplateJustifyItemsStretch = TemplateJustifyItemsStretchTemplate.bind({});
